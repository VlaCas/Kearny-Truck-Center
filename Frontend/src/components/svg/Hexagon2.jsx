export default function Hexagon2Svg({ children }) {
  return (
    <div className="relative w-40 h-40 sm:w-36 sm:h-36 md:h-40 md:w-40 lg:h-44 lg:w-44 xl:w-48 xl:h-48">
      <svg fill="#C9534F" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
