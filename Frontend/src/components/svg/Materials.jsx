export default function MaterialsSvg({color}) {
  return (
    <svg className="absolute -translate-x-1/2 -translate-y-1/2 w-14 h-14 left-1/2 top-1/2 lg:w-[66px] lg:h-[66px] xl:w-[72px] xl:h-[72px]" viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlnssketch="http://www.bohemiancoding.com/sketch/ns" fill={`${color == 'white' ? '#fff' : "#C9534F"}`}>
      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
      <g id="SVGRepo_iconCarrier"> 
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" sketchtype="MSPage"> 
          <g id="Icon-Set" sketchtype="MSLayerGroup" transform="translate(-569.000000, -308.000000)" fill={`${color == 'white' ? '#fff' : "#C9534F"}`}> 
