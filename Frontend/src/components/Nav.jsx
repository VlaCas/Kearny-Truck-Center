...
export default function Nav() {
  ...
  return (
    <>
      <nav className={`flex items-center bg-transparent px-4 py-10 top-0 justify-between w-full max-w-[1950px] absolute left-0 h-[70px] sm:py-12 sm:h-[90px] md:h-[108px] md:px-6 lg:py-0 lg:top-[59px] lg:justify-center lg:h-[90px] lg:bg-[rgba(6,26,35,0.55)] xl:px-3 xl:py-4 ${isScrolled ?'z-10' : 'z-20'}`}>
