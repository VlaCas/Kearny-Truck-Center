    ...
    <>
      ...
      <ul className='flex flex-wrap justify-center xm:justify-start xm:w-[462px] md:w-[750px] md:justify-center lg:w-[950px] xl:w-[1270px]'>
        <li className='mt-8 xm:w-[231px] md:w-[250px] lg:w-[316px] xl:w-[390px] '>
            <a href='services#engine-repair' title='Services engine repair image' className='relative block h-[200px] w-[300px] bg-cover bg-center xm:w-[231px] xm:h-[154px] md:w-[250px] md:h-[166px] lg:w-[316px] lg:h-[220px] xl:w-[390px] xl:h-[260px] lg:hover:bg-opacity-50 lg:hover:cursor-pointer' style={{backgroundImage: `url(${image6})`}} >
            ...
            <h4 className={`${!H4BgColor ? 'bg-[#f1e6da]' : H4BgColor} py-2 px-4 xl:py-4 xl:px-6 hover:text-opacity-30`}>  
              <a href='services#engine-repair' title='Services engine repair title' className='flex items-center justify-between text-sm font-semibold open-sans xl:text-lg lg:hover:text-[rgba(0,0,0,0.3)] transition-all'>ENGINE REPAIR<span className='text-2xl text-[#C9534F] float-right open-sans after:font-bold after:content-[">"] xl:text-4xl lg:hover:text-[rgba(201,83,79,0.59)] transition-all'></span></a>
            </h4>
				</li>
        <li className='mt-8 xm:w-[231px] md:w-[250px] lg:w-[316px] xl:w-[390px]'>
            <a href='services#lube-oil-filters' title='services lube oil filters image' className='relative block h-[200px] w-[300px] bg-cover bg-center xm:w-[231px] xm:h-[154px] md:w-[250px] md:h-[166px] lg:w-[316px] lg:h-[220px] xl:w-[390px] xl:h-[260px] lg:hover:bg-opacity-20 lg:hover:cursor-pointer ' style={{backgroundImage: `url(${image7})`}} >
              <span className='absolute w-full h-full bg-[rgba(255,255,255,0.0)] lg:hover:bg-[rgba(255,255,255,0.3)] transition-all'></span>
            </a>
            <h4 className={`${!H4BgColor ? 'bg-[#f1e6da]' : H4BgColor} py-2 px-4 xl:py-4 xl:px-6 hover:text-opacity-30`}>  
              <a href='services#lube-oil-filters' title='services lube oil filters title' className='flex items-center justify-between text-sm font-semibold open-sans xl:text-lg lg:hover:text-[rgba(0,0,0,0.3)] transition-all'>LUBE, OIL AND FILTERS <span className='text-2xl text-[#C9534F] float-right open-sans after:font-bold after:content-[">"] xl:text-4xl lg:hover:text-[rgba(201,83,79,0.59)] transition-all'></span></a>
            </h4>
				</li>
        <li className='mt-8 xm:w-[231px] md:w-[250px] lg:w-[316px] xl:w-[390px]'>
            <a href='services#transmission-repair' title='services transmission repair image' className='relative block h-[200px] w-[300px] bg-cover bg-center xm:w-[231px] xm:h-[154px] md:w-[250px] md:h-[166px] lg:w-[316px] lg:h-[220px] xl:w-[390px] xl:h-[260px] lg:hover:bg-opacity-20 lg:hover:cursor-pointer ' style={{backgroundImage: `url(${image19})`}} >
              <span className='absolute w-full h-full bg-[rgba(255,255,255,0.0)] lg:hover:bg-[rgba(255,255,255,0.3)] transition-all'></span>
            </a>
            <h4 className={`${!H4BgColor ? 'bg-[#f1e6da]' : H4BgColor} py-2 px-4 xl:py-4 xl:px-6 hover:text-opacity-30`}>  
              <a href='services#transmission-repair' title='services transmission repair title' className='flex items-center justify-between text-sm font-semibold open-sans xl:text-lg lg:hover:text-[rgba(0,0,0,0.3)] transition-all'>TRANSMISSIONS REPAIR<span className='text-2xl text-[#C9534F] float-right open-sans after:font-bold after:content-[">"] xl:text-4xl lg:hover:text-[rgba(201,83,79,0.59)] transition-all'></span></a>
            </h4>
				</li>
      </ul>
      <div className='flex justify-center'>
        <button className='bg-[#C9534F] py-4 px-6 rounded-full transition-all lg:hover:bg-[#892d2a] open-sans text-white mt-12'>
          <a href='services' title='all services' className='font-semibold open-sans'>VIEW ALL SERVICES</a>
        </button>
      </div>
    </>
  )
